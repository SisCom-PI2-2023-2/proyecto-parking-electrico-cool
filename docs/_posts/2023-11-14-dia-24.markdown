...
En el video que sigue se puede ver la prueba de encendido de leds de acuerdo al status del sensor:
...
<body>
    ...
    <video width="640" height="360" controls>
        <source src="/proyecto-volt-park/assets/Leds_Sensores.mp4" type="video/mp4">
