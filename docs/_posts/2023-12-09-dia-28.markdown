...
layout: post
title:  "Día 28"
date:   2023-12-09 19:30:00 -0300
categories: posts
---

Se continúa trabajando en código para mostrar en display 7 segmentos utilizando un decodificador de BCD a 7seg la cantidad disponible de lugares en el estacionamiento, queda funcionando ok. 
Se trabaja en la lógica necesaria para la salida del parking. Se continúa trabajando en la maqueta.

Se muestra a continuación el código utilizado para la entrada al parking agregnado la muestra de cantidad de autos disponibles en el display 7 segmentos:
...
El código utilizado para la salida del parking es el siguiente:
