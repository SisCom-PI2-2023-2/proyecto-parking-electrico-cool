...
layout: post
title:  "Día 5"
date:   2023-08-29 19:30:00 -0300
categories: posts
---

Se trabaja en el Anteproyecto (Elección de nombre del proyecto, Objetivo, Descripción general y Diseño Preliminar en 3D). 

Nombre del Proyecto: Volt Park

Diseño preliminar en 3D:

![Diseño3D](/proyecto-volt-park/assets/Diseño_3D.JPG)

Pruebas para testear conexión con Thingsboard. Se detalla código utilizado a continuación:
...
const char* token = "2IH6akhdXR0iArAmiNNV";
...
void loop() {
  ...
  if (now - lastMsg > msgPeriod) {
    ...
    temperature = 25;  // Leer la temperatura
    humidity = 0    ;    // Leer la humedad
...
```
Se muestra a continuación un video donde desde la plataforma Thingsboard se indica el encendido de un led de la placa ESP8266

  <video src="[docs/assets/](https://github.com/SisCom-PI2-2023-2/proyecto-volt-park/blob/main/docs/assets/Conexion_Thingsboard.mp4)https://github.com/SisCom-PI2-2023-2/proyecto-volt-park/blob/main/docs/assets/Conexion_Thingsboard.mp4" width="300" heigth="208" preload="none" controls></video>
