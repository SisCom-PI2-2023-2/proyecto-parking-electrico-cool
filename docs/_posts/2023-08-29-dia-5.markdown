...
Se muestra a continuación un video donde desde la plataforma Thingsboard se indica el encendido de un led de la placa ESP8266
  ...
  <video src="https://github.com/SisCom-PI2-2023-2/proyecto-volt-park/blob/main/docs/assets/Conexion_Thingsboard.mp4" width="300" heigth="208" preload="none" controls></video>
