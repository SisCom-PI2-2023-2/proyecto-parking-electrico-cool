...
En resumen, el presupuesto inicial era de UYU 8000 y se gastaron UYU 5769 quedando un saldo de UYU 2231. Tener en cuenta que los precios de los componentes desde el momento de la compra a la actualidad pueden haber variado.
